...
interact_plot(mod, pred = LifeStress.c, modx = Neuroticism.c, 
	...
	color.class = c("darkgray","#3366ff","#3366ff"),
	line.thickness = 1.3)

# Figure 5. marginal effects plots
johnson_neyman(mod, pred = Neuroticism.c, modx = LifeStress.c, sig.color = "#567001", 
	insig.color = "darkgray", mod.range = c(min(sim.data$LifeStress.c), max(sim.data$LifeStress.c)),
	title = NULL)
johnson_neyman(mod, pred = LifeStress.c, modx = Neuroticism.c, sig.color = "#3366ff", 
...
interact_plot(mod, pred = Neuroticism.c, modx = LifeStress.c, modx.values = c(-1.77, 0, 0.11, 1.77, 6.05),
	...
	color.class = c("darkgray","darkgray","#567001","#567001","#567001"),
	line.thickness = 1.3)
...
johnson_neyman(mod, pred = Neuroticism.c, modx = LifeStress.c, 
	...
	title = NULL)$cband
# used output from PROCESS for figure 6 CBs
...
abline(a = -0.00000000000000003163, b = 0.07960638525025363899, col = "#567001", lwd = 3)

plot(sim.data[c("LifeStress.c", "Depression.c")])
abline(a = -0.00000000000000003163, b = 0.14206996236015134727, col = "#3366ff", lwd = 3)
